...
if ( ! class_exists( 'Automobile_Hub_WPTT_WebFont_Loader' ) ) {
	...
	class Automobile_Hub_WPTT_WebFont_Loader {
		 ...
		 * @access public
		 * @since 1.0.0
		 * @return array Returns an array of remote URLs and their local automobile_hub_counterparts.
		 */
...
if ( ! function_exists( 'wptt_get_web_automobile_hub_font_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function wptt_get_web_automobile_hub_font_url( $url, $format = 'woff2' ) {
		$font = new Automobile_Hub_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
