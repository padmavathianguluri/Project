...
if ( ! defined( 'AUTOMOBILE_HUB_DOCS_THEME_URL' ) ) {
    define( 'AUTOMOBILE_HUB_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/automobile-hub-lite/' );
}
...
function automobile_hub_get_bundle() {
	...
	?>
		<div class="wrap about-wrap">
			...
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 65+ Themes At 15% Discount. ', 'automobile-hub' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 65+ Themes At 15% Discount use the coupon', 'automobile-hub' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
