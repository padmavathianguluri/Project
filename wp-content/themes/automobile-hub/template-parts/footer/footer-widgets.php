...
<div class="container">
    <aside class="widget-area row py-2 pt-3" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'automobile-hub' ); ?>">
        <div class="<?php echo esc_attr($automobile_hub_col_lg_footer_class); ?> <?php echo esc_attr($automobile_hub_col_md_footer_class); ?>">
            <?php dynamic_sidebar('footer-1'); ?>
        </div>
        <?php
        // Footer boxes 2 and onwards.
        for ($i = 2; $i <= $automobile_hub_no_of_footer_col; $i++) :
            if ($i <= $automobile_hub_no_of_footer_col) :
                ?>
               <div class="col-12 <?php echo esc_attr($automobile_hub_col_lg_footer_class); ?> <?php echo esc_attr($automobile_hub_col_md_footer_class); ?>">
