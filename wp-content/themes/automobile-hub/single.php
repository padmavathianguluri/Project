	...
	<main id="tp_content" role="main">
		...
		<div class="container">
			<div id="primary" class="content-area">
				<?php
		        $automobile_hub_sidebar_single_post_layout = get_theme_mod( 'automobile_hub_sidebar_single_post_layout','right');
		        if($automobile_hub_sidebar_single_post_layout == 'left'){ ?>
			        <div class="row">
			    ...
			    <?php }else if($automobile_hub_sidebar_single_post_layout == 'right'){ ?>
			        <div class="row">
			          	<div class="col-lg-8 col-md-8">	           
				            <?php
								/* Start the Loop */
			    ...
			    <?php }else if($automobile_hub_sidebar_single_post_layout == 'full'){ ?>
			        <div class="full">
			           <?php
							/* Start the Loop */
							while ( have_posts() ) : the_post();
